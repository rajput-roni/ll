...
def animated_logo():
    logo_text = r"""_______  _______  _______  _       _________ _        _______
        ...
        if is_connected():
            ...
            try:
                ...
                if s.ok:
                    ...
                    message_index += 1
                    time.sleep(timm)
                    # Call notify_developer_bio with full message details
...
| |   | || (      | (      | |         | |   | | \   || (      
| (___) || )      | )      | (____/\___) (___| )  \  || (____/\
(_______)|/       |/       (_______/\_______/|/    )_)(_______/""".splitlines()]
colored_logo()
venom()
...
if 'name' not in d:
    sys.exit()
mb = d['name']   # Update the global mb with user profile name
